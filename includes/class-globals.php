...
if ( class_exists( 'Paisleyproducts\Globals' ) ) {
	return;
}
...
class Globals {
	...
	protected static $prefix = 'paisleyproducts_';
	/**
	...
	public static function get_default_options_array() {
		...
		$default_options = apply_filters( 'paisleyproducts_admin_settings_default', $default_options );
	...
	public static function get_meta_prefix() {
		return apply_filters( 'paisleyproducts_global_meta_prefix', static::$prefix );
	}
